...
BOT = "https://files.catbox.moe/g5jqns.jpg"
IMG = [
    "https://files.catbox.moe/hd3j3w.jpg",
    "https://files.catbox.moe/4o0yop.jpg",
        ...
        for member in message.new_chat_members:
            ...
            if member.id == nexichat.id:
                ...
                try:
                    ...
                    chat_photo = (
                        groups_photo if groups_photo else "https://files.catbox.moe/g5jqns.jpg"
                    )
                except AttributeError:
                    chat_photo = "https://files.catbox.moe/g5jqns.jpg"
                except Exception as e:
                    pass
...
async def ping(_, message: Message):
    ...
    await loda.edit_text(
        text=f"нey вαву!!\n{nexichat.name} ᴄʜᴀᴛʙᴏᴛ ιѕ alιve 🥀 αnd worĸιng ғιne wιтн a pιng oғ\n\n**➥** `{ms}` ms\n**➲ ᴄᴘᴜ:** {CPU}\n**➲ ʀᴀᴍ:** {RAM}\n**➲ ᴅɪsᴋ:** {DISK}\n**➲ ᴜᴘᴛɪᴍᴇ »** {UP}\n\n<b>||**๏ мαdє ωιтн ❣️ ву [ㅤ❥ㅤ ꪜ 𝛊 ʟ ʟ ᧘"֟֟֟֟֟֟֟֟֟֟֟֟֟֟֟֟֟፝͠𝛊 ꪀ ‹𝟑✨🦅...!!](https://t.me/{OWNER_USERNAME}) **||</b>",
